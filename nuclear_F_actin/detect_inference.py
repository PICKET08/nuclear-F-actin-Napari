...
#     detector = DetectONNX(r"C:\Users\Administrator\Desktop\ImageJ\models\det\yolov8s.onnx")
#     segmentor = SegmentONNX(r"C:\Users\Administrator\Desktop\ImageJ\models\seg\nested_unet.onnx")
#     image = Image.open(r"C:\Users\Administrator\Desktop\Unet-Zoo-Cell\data\PLOS-Test\0005.jpg")
#     img = np.array(image)
#     detector.image = img
#     segmentor.image = img
#
#     result = segmentor.draw(*detector.crop())
